    ...
    public partial class V2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalsUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnimalsUsers_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnimalsUsers_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalsUsers_AnimalId",
                table: "AnimalsUsers",
                column: "AnimalId");

            migrationBuilder.CreateIndex(
                name: "IX_AnimalsUsers_UserId",
                table: "AnimalsUsers",
                column: "UserId");
        }
